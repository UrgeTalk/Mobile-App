...
class _LatestVideosState extends State<LatestVideos> {
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: const BoxDecoration(
                    ...
                    child: CircleAvatar(
                      radius: 35,
                      backgroundImage: NetworkImage(_profileController.profileModel.profilePicture??""),
                    ),
              ),
            )
          ],
                ...
                if (_homeController.isListLoading.value) {
                  ...
                  return ListView.builder(
                      ...
                      itemBuilder: ((context, index) {
                        HomeModel _model = _homeController.lastestVideos[index];
                        return latestVideos(_model);
                      }));
                }
              }),
            ),
  ...
  Widget latestVideos(HomeModel _model) {
